...
def download_sia_data(year : int, month : int, uf : str = 'CE') -> str:
    ...
    try:
        ...
        with TemporaryDirectory() as temp_dir:
            SIA.download([uf], [year], [month], groups=data_group, data_dir=temp_dir)
...
def main():
    ...
    download_data_parallel(ufs, years, months, downloadFun = download_sia_data)
