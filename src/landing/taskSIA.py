...
load_dotenv()
prefix_sia = os.getenv("PREFIX_SIA")
...
if __name__ == "__main__":
    ...
    task_download_files(prefix=prefix_sia, years=years, months=months, ufs=ufs, data_group=data_group_sih, download_function=SIA.download)
